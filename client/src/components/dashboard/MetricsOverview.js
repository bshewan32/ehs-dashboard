...
const MetricsOverview = ({ metrics }) => {
  ...
  const processMetrics = useCallback(() => {
    ...
    // If metrics exist, use them but ensure the structure is complete
    setLocalMetrics({
      ...metrics,
      ...
      leading: metrics.leading || {
        trainingCompleted: metrics.trainingCompleted || 0,
  ...
  // Safely access leading indicators with proper fallbacks
